(function($) {
    ...
    const floorPlans = [
        { id: 1, imgSrc: 'assets/img/projects/BIDADA _SIR _AUSA_3D.jpg' },
        { id: 2, imgSrc: 'assets/img/projects/Biradar_Sir_0_TONDAR.jpg' },
        { id: 3, imgSrc: 'assets/img/projects/DR.TALWADE_02.jpg' },
        { id: 4, imgSrc: 'assets/img/projects/MOMLE_SIR_04.jpg' },
        { id: 5, imgSrc: 'assets/img/projects/SAIDHAM_APARTMENT.jpg' }
    ];
    ...
    floorPlans.forEach(plan => {
        document.querySelector(`.floorPlanButton[data-id="${plan.id}"]`).addEventListener('click', function() {
            openModal(`floorPlanModal${plan.id}`, plan.imgSrc);
        });

        document.getElementById(`closeModal${plan.id}`).addEventListener('click', function() {
            closeModal(`floorPlanModal${plan.id}`);
        });

        // Close modal when clicking outside of the image
        window.addEventListener('click', function(event) {
            var modal = document.getElementById(`floorPlanModal${plan.id}`);
